...
def get_info(links):
	"""Function that takes a list of links and for each link, will store the 
	text from the article into a separte .txt file with randomnly generated 
	name. Will also update the .csv file with information about each stored 
	article. 
